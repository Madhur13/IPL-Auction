...
<br>
      ...
      <div class="input-field col s12">
          <input id="last_name" type="text" class="validate" name="owner_name" style="color:white;">
          <label for="email">Owner Name</label>
        </div>
     
      <div class="input-field col s12">
          <input id="last_name" type="text" class="validate" name="team_name" style="color:white;">
          <label for="email">Team Name</label>
        </div>
      <div class="input-field col s12">
          <input id="last_name" type="text" class="validate" name="Email" style="color:white;">
        ...
        <div class="input-field col s12">
          <input id="last_name" type="text" class="validate" name="phone" style="color:white;">
          <label for="email">Phone Number</label>
        </div>
        <div class="input-field col s12">
          <input id="last_name" type="text" class="validate" name="budget" style="color:white;">
