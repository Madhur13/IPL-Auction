					...
					<div class="col-1-3">
						<div class="wrap-col item">
							...
							<div class="item-content">
								<center><h1>TOP WICKET TAKERS</h1></center>
								
				
								<?php
								include('slot2.php');
				?>
								<a class="btn" href="allpurplecaps.php">More Details</a>
							</div>
						</div>
					</div>
					<div class="col-1-3">
						<div class="wrap-col item">
							...
							<div class="item-content">
								<center><h1>BEST ECONOMY</h1></center>
								
				
								<?php
								include('slot4.php');
								?>
									<center><a class="btn" href="alleconomys.php">More Details</a></center>
							</div>
						</div>
					</div>
					<div class="col-1-3">
						<div class="wrap-col item">
							...
							<div class="item-content">
								<span><h1>BOWLER BEST</h1></span><br>
								<?php
								include('bowlbest.php');
								?>
